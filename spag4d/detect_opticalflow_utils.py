...
class CoTrackerVisualizer:
    ...
    def save_video(self, video, filename, writer=None, step=0):
        if writer is not None:
            ...
            video_writer = cv2.VideoWriter(save_path, fourcc, self.fps, (video.shape[-1], video.shape[-2]))
            # video_writer = imageio.get_writer(save_path, fps=self.fps, plugin='pyav', codec='mpeg4')
